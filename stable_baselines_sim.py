...
# model = DDPG(MlpPolicy, env, verbose=1,nb_train_steps=NEPISODES, nb_rollout_steps=NSTEPS,nb_eval_steps=NSTEPS,gamma=DECAY_RATE, param_noise=None, action_noise=action_noise,batch_size=BATCH_SIZE,actor_lr=POLICY_LEARNING_RATE,
...
robot.LOGDATA = 1
robot.SINCOS=1
robot.video_path = "/home/pasquale/Desktop/thesis/thesis-code/1D_pendulum/Video/stable_baselines"
robot.setupSim()
...
mean_reward,std_reward = evaluate_policy(model,n_eval_episode = 10)